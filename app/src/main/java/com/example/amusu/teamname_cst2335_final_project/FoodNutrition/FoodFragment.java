...
public class FoodFragment extends Fragment {
    ...
    class FavorAdapter extends ArrayAdapter{
        ...
        public View getView(int position,  View convertView, ViewGroup parent) {
            ...
            HashMap<String, String> food = (HashMap<String, String>) getItem(position);
            ...
            delete.setOnClickListener(e->{FoodMainActivity.getDb().delete(DataBaseHelper.TABLE_NAME,DataBaseHelper.KEY_NAME + "=?", new String[]{food.get("Label")});});
